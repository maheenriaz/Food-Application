  ...
  return(
     <View>
          ...
          <View style={{marginTop:moderateScaleVertical(80),marginLeft:moderateScaleVertical(20)}}>
              <Text style={{marginTop:moderateScaleVertical(20),color:'#302E2D',marginTop:moderateScaleVertical(40),fontSize:textScale(20)}}>You Know the drill</Text>
              
             <Text style={{marginTop:moderateScaleVertical(20),paddingLeft:10,color:'grey'}}>Username</Text>
              <TextInput style={{width:'90%',height:40,borderWidth:1,borderColor:'grey'
                  ,borderRadius:20,padding:10,marginLeft:8,marginTop:moderateScaleVertical(17),color:'grey'}} 
                  placeholder="" />
             <Text style={{marginTop:moderateScaleVertical(20),paddingLeft:10,color:'grey'}}>Password</Text>
             <TextInput style={{width:'90%',height:40,borderWidth:1,borderColor:'grey'
                  ,borderRadius:20,padding:10,marginLeft:moderateScaleVertical(8),marginTop:moderateScaleVertical(10),color:'grey'}} 
                  placeholder="" />
             <Text style={{marginTop:20,paddingLeft:10,color:'grey'}}>Repeat Password</Text>
             <TextInput style={{width:'90%',height:40,borderWidth:1,borderColor:'grey'
