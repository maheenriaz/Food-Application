  ...
  return(
     <View>
          ...
          <View style={{marginTop:moderateScaleVertical(80),marginLeft:moderateScaleVertical(20)}}>
              <Text style={{marginTop:moderateScaleVertical(20),color:'#302E2D',marginTop:moderateScaleVertical(40),fontSize:textScale(20)}}>Let's setup your profile</Text>
               <View style={{flexDirection:'row'}}>
                    <Image  source={{uri:'https://i.stack.imgur.com/l60Hf.png'}}
                     style={{width:100,height:90,marginLeft:moderateScaleVertical(10),borderRadius:180,marginTop:moderateScaleVertical(10)}} />
                   <Text style={{marginTop:20,color:'grey',marginTop:40,fontSize:textScale(17),paddingLeft:10}}>Add a Profile Picture</Text>
              </View>
              <Text style={{marginTop:moderateScaleVertical(20),color:'#E05F00',marginTop:moderateScaleVertical(4),fontSize:textScale(17),marginLeft:moderateScaleVertical(50)}}>Edit</Text>
              <Text style={{marginTop:moderateScaleVertical(20),paddingLeft:10,color:'grey'}}>Your Name</Text>
             ...
             <Text style={{marginTop:moderateScaleVertical(20),paddingLeft:10,color:'grey'}}>Bio</Text>
                <TextInput style={{width:'90%',height:80,borderWidth:1,borderColor:'grey'
