  ...
  return(
       <View style={{flexDirection:'row',height:50,backgroundColor:'white',width:'100%'}}>
             <View style={{flexDirection:'row',marginTop:moderateScaleVertical(17)}}>
                  <MaterialIcons name="menu" style={{marginLeft:moderateScaleVertical(10)}} size={24} color="black"  />
                  <Text style={{marginLeft:moderateScaleVertical(140),fontSize:textScale(20)}}>Explorer</Text>
             </View>
             </View>
     )
  }
